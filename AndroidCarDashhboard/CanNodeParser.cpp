...
CanParserError CanNodeParser::getData(const QByteArray& msg, int8_t& data)
{
...
CanParserError CanNodeParser::getData(const QByteArray& msg, uint8_t& data)
{
    //check configuration byte
...
CanParserError CanNodeParser::getData(const QByteArray& msg, int16_t& data)
{
    //check configuration byte
    ...
    data  = (int16_t) data[1];
    data |= (int16_t) (data[2]<<8);
    return DATA_OK;
}

/// \brief Get an unsigned 16-bit integer from a CanMessage.
CanParserError CanNodeParser::getData(const QByteArray& msg, uint16_t& data)
{
    //check configuration byte
    ...
    data |= (uint16_t) (data[2]<<8);
    return DATA_OK;
}

/// \brief Get a signed 32-bit integer from a CanMessage.
CanParserError CanNodeParser::getData(const QByteArray& msg, int32_t& data)
{
    //check configuration byte
    ...
    data  = (int32_t) data[1];
    data |= (int32_t) (data[2]<<8);
    data |= (int32_t) (data[3]<<16);
    data |= (int32_t) (data[4]<<24);
    return DATA_OK;
}

/// \brief Get an unsigned 32-bit integer from a CanMessage.
CanParserError CanNodeParser::getData(const QByteArray& msg, uint32_t& data)
{
    //check configuration byte
    ...
    data |= (uint32_t) (data[2]<<8);
    data |= (uint32_t) (data[3]<<16);
    data |= (uint32_t) (data[4]<<24);
    return DATA_OK;
}
