...
public:
    ...
    static CanParserError getData(const QByteArray& msg,   int8_t& data);
    /// \brief Get an unsigned 8-bit integer from a CanMessage.
    static CanParserError getData(const QByteArray& msg,  uint8_t& data);
    /// \brief Get a signed 16-bit integer from a CanMessage.
    static CanParserError getData(const QByteArray& msg,  int16_t& data);
    /// \brief Get an unsigned 16-bit integer from a CanMessage.
    static CanParserError getData(const QByteArray& msg, uint16_t& data);
    /// \brief Get a signed 32-bit integer from a CanMessage.
    static CanParserError getData(const QByteArray& msg,  int32_t& data);
    /// \brief Get an unsigned 32-bit integer from a CanMessage.
    static CanParserError getData(const QByteArray& msg, uint32_t& data);
